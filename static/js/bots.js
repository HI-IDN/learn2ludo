...
const FALLBACK_BOTS = [
  ...
  { id: 'hermes', name: 'Hermes', type: 'heuristic', epithet: 'God of Travel', description: 'Keeps pawns distributed across the board.', focus: 'Spread pawns for flexibility.', status: 'Available', selectable: true, implemented: true },
];
